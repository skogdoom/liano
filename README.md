...
**M** mutes the sound, **F** (or the button next to the speaker) toggles full screen, **D** shows hitboxes and the predicted flight. Phones and iPads play in either orientation. iPhone Safari has no full screen for web pages: add the game to the Home Screen to play it without the browser bars.
