...
// (see KEYS in config.js). Only single player is enabled so far; the two-player modes
// arrive in milestones 20 (split) and 21 (shared).
export const MODES = Object.freeze({
  ...
  split: { id: 'split', label: '2P split', players: 2, lives: LIVES_2P, keys: ['p1', 'p2'], enabled: false },
});
